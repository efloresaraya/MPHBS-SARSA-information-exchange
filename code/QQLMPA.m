...
while Iter<Max_iter
    ...
    for i=1:size(Prey,1)
        ...
        % Evaluate the updated position and update the reward table.
        ...
        for k=1:episode
            ...
            Q_table(current_state,chosen_action) = Q_table(current_state,chosen_action)+studyrate*(r+gamma * maxQ -Q_table(current_state,chosen_action)); %Bellman·½³Ì
